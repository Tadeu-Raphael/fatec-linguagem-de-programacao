...
printf("transforma uma letra de maiusculo para minusculo e vice versa\n");

for(;;){
    printf("digite uma letra do alfabeto: ");
    scanf("%c",&b);   //recebe uma letra
    getchar();

    if(b == '0')
        break;

    printf("chama a funcao transf(). \n");
    printf("A funcao transf() retorna o resultado que e' atribuido a variavel c\n\n");

    a = transf(b);   /* chama a funcao "transf" e passa como informacao uma copia do
                        valor de "b" e espera o retorno de um valor do tipo "int" */
...
int transf(char x) /* na frente do <nome_da_funcao> esta' declarado o
                   <tipo_de_retorno> ou o tipo de valor que o comando "return"
                   vai retornar */
{
int z;

printf("\tfuncao transf() \n");
printf("\ta funcao transforma uma letra de maiusculo para minusculo e vice versa\n");
printf("\tretorna o resultado com o comando return\n\n");
...
return(z); /* retorna o resultado da transformacao da letra guardado em "z" neste
              caso "int" */
}
#endif
...
1 - Escreva um programa que receba uma letra via teclado. Escreva uma funcao que
    ...
    digitada.(utilize o comando return). O vetor deve ser uma variavel global. (FEITO)
